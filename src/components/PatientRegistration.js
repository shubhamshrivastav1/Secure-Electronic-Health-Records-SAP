...
const PatientRegistry = () => {
  ...
  const handleRegister = () => {
    ...
    if (hhNumber.length !== 6) {
      alert("Please enter a valid 6-digit HH Number.");
      return;
    }
      ...
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-b from-black to-gray-800 font-mono">
        <div className="w-full max-w-4xl">
          ...
          <form className="bg-gray-900 p-6 rounded-lg shadow-lg grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="mb-4">
              <label className="block font-bold text-white" htmlFor="walletAddress">
            ...
            <div className="space-x-4 md:col-span-2 flex justify-center mt-6">
              ...
              <button
                ...
                className="px-5 py-2.5 bg-teal-500 text-white font-bold text-lg rounded-lg cursor-pointer transition-colors duration-300 ease-in-out hover:bg-gray-600 w-full md:w-auto"
              >
                Close
              </button>
            </div>
